...
{
    SDL_Rect destRect = {this->_position.x, this->_position.y, this->_size.x * static_cast<int>(globals::SPRITE_SCALE), this->_size.y * static_cast<int>(globals::SPRITE_SCALE)};
